...
// Begin SCDS-328 -----------------------------------------------------------------------
// The test "InvalidParseNoComma" is originally for CDN-Loops, but needs to be
// disabled because now this construct is valid (equivalent to "1.0 cdn1")
...
TEST(ParseCdnInfoListTest,SCDS328ParseViaHeader) {
  const std::string value = "1.0 cdn2";
  ParseContext input(value);
  EXPECT_THAT(parseCdnInfoList(input),
              IsOkAndHolds(ParsedCdnInfoList(ParseContext(value, 8), {"1.0 cdn2"})));
}

TEST(ParseCdnInfoListTest,SCDS328ParseViaHeaderWithPort) {
  const std::string value = "1.0 cdn2:80";
  ParseContext input(value);
  EXPECT_THAT(parseCdnInfoList(input),
              IsOkAndHolds(ParsedCdnInfoList(ParseContext(value, 11), {"1.0 cdn2:80"})));
}

TEST(ParseCdnInfoListTest,SCDS328ParseViaHeaderWithProtocol) {
  const std::string value = "HTTP/1.0 cdn2";
  ParseContext input(value);
  EXPECT_THAT(parseCdnInfoList(input),
              IsOkAndHolds(ParsedCdnInfoList(ParseContext(value, 13), {"HTTP/1.0 cdn2"})));
}

TEST(ParseCdnInfoListTest,SCDS328ParseViaHeaderWithProtocolWithPort) {
  const std::string value = "HTTP/1.0 sepp.ericsson.se:80";
  ParseContext input(value);
  EXPECT_THAT(parseCdnInfoList(input),
              IsOkAndHolds(ParsedCdnInfoList(ParseContext(value, 28), {"HTTP/1.0 sepp.ericsson.se:80"})));
}

TEST(ParseCdnInfoListTest,SCDS328ParseViaHeaderWithProtocolWithPortAndTabs) {
  const std::string value = "HTTP/1.0\t\tcdn2:80";
  ParseContext input(value);
  EXPECT_THAT(parseCdnInfoList(input),
              IsOkAndHolds(ParsedCdnInfoList(ParseContext(value, 17), {"HTTP/1.0\t\tcdn2:80"})));
}

TEST(ParseCdnInfoListTest,SCDS328ParseViaHeaderWithSpaces) {
  const std::string value = " 1.0   cdn2 ";
  ParseContext input(value);
  EXPECT_THAT(parseCdnInfoList(input),
              IsOkAndHolds(ParsedCdnInfoList(ParseContext(value, 12), {"1.0   cdn2"})));
}

TEST(ParseCdnInfoListTest,SCDS328ParseMultipleViaHeader) {
  const std::string value = "1.0 cdn2, 1.1 cdn3";
  ParseContext input(value);
  EXPECT_THAT(parseCdnInfoList(input),
              IsOkAndHolds(ParsedCdnInfoList(ParseContext(value, 18), {"1.0 cdn2", "1.1 cdn3"})));
}

TEST(ParseCdnInfoListTest,SCDS328ParseViaHeaderIPv6) {
  const std::string value = "1.0 [2001:Db8::192.0.2.0]";
  ParseContext input(value);
  EXPECT_THAT(parseCdnInfoList(input),
              IsOkAndHolds(ParsedCdnInfoList(ParseContext(value, 25), {"1.0 [2001:Db8::192.0.2.0]"})));
}

TEST(ParseCdnInfoListTest,SCDS328ParseViaHeaderWithPortIPv6) {
  const std::string value = "1.0 [2001:Db8::192.0.2.0]:80";
  ParseContext input(value);
  EXPECT_THAT(parseCdnInfoList(input),
              IsOkAndHolds(ParsedCdnInfoList(ParseContext(value, 28), {"1.0 [2001:Db8::192.0.2.0]:80"})));
}

TEST(ParseCdnInfoListTest,SCDS328ParseViaHeaderWithProtocolIPv6) {
  const std::string value = "HTTP/1.0 [2001:db8::1]";
  ParseContext input(value);
  EXPECT_THAT(parseCdnInfoList(input),
              IsOkAndHolds(ParsedCdnInfoList(ParseContext(value, 22), {"HTTP/1.0 [2001:db8::1]"})));
}

TEST(ParseCdnInfoListTest,SCDS328ParseViaHeaderWithProtocolWithPortAndTabsIPv6) {
  const std::string value = "HTTP/1.0\t\t[2001:DB8::1]:80";
  ParseContext input(value);
  EXPECT_THAT(parseCdnInfoList(input),
              IsOkAndHolds(ParsedCdnInfoList(ParseContext(value, 26), {"HTTP/1.0\t\t[2001:DB8::1]:80"})));
}

TEST(ParseCdnInfoListTest,SCDS328ParseViaHeaderWithSpacesIPv6) {
  const std::string value = " 1.0   [2001:DB8::1] ";
  ParseContext input(value);
  EXPECT_THAT(parseCdnInfoList(input),
              IsOkAndHolds(ParsedCdnInfoList(ParseContext(value, 21), {"1.0   [2001:DB8::1]"})));
}

TEST(ParseCdnInfoListTest,SCDS328ParseMultipleViaHeaderIPv6) {
  const std::string value = "1.0 [2001:DB8::1], 1.1 [2001:Db8::192.0.2.0]";
  ParseContext input(value);
  EXPECT_THAT(parseCdnInfoList(input),
              IsOkAndHolds(ParsedCdnInfoList(ParseContext(value, 44), {"1.0 [2001:DB8::1]", "1.1 [2001:Db8::192.0.2.0]"})));
}

TEST(ParseCdnInfoListTest,SCDS328ParseMultipleViaHeaderIPv4IPv6) {
  const std::string value = "1.0 [2001:DB8::1], 1.1 [2001:Db8::192.0.2.0], HTTP/2.0 sepp.ericsson.se:80";
  ParseContext input(value);
  EXPECT_THAT(parseCdnInfoList(input),
              IsOkAndHolds(ParsedCdnInfoList(ParseContext(value, 74), {"1.0 [2001:DB8::1]", "1.1 [2001:Db8::192.0.2.0]", "HTTP/2.0 sepp.ericsson.se:80"})));
}
// End SCDS-328 -----------------------------------------------------------------------------
