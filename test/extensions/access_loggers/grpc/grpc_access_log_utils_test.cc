...
TEST(UtilityResponseFlagsToAccessLogResponseFlagsTest, All) {
  ...
  common_access_log_expected.mutable_response_flags()->set_absolute_path_rejected(true);
  common_access_log_expected.mutable_response_flags()->set_missing_path_rejected(true);  
  common_access_log_expected.mutable_response_flags()->set_request_payload_too_large(true);
