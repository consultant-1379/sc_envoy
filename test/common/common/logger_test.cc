...
public:
  ...
  void expectLogMessage(const std::string& pattern, const std::string& message,
    ...
    formatter
        ...
        .set_pattern(pattern);
    formatter
      ->add_flag<CustomFlagFormatter::EscapeMessageULId>(
        CustomFlagFormatter::EscapeMessageULId::Placeholder
      ).set_pattern(pattern);
    formatter
      ->add_flag<CustomFlagFormatter::EscapeMessageC>(
        CustomFlagFormatter::EscapeMessageC::Placeholder
      ).set_pattern(pattern);
    formatter
      ->add_flag<CustomFlagFormatter::EscapeMessageS>(
        CustomFlagFormatter::EscapeMessageS::Placeholder
      ).set_pattern(pattern);
...
TEST_P(LoggerCustomFlagsTest, LogULIDEscaped) {
    expectLogMessage("%U", "[Tags: \"key1\":\"val1\",\"UlId\":\"R555\",\"key3\":\"val3\"] message1", "R555");
    expectLogMessage("%U", "[Tags: \"UlId\":\"E7894\",\"key2\":\"val2\",\"key3\":\"val3\"] message1", "E7894");
    expectLogMessage("%U", "[Tags: \"key1\":\"val1\",\"key2\":\"val2\",\"UlId\":\"H57748\"] message1", "H57748");

    expectLogMessage("ul_id: %U, message: %+", "[Tags: \"key1\":\"val1\",\"UlId\":\"R555\",\"key3\":\"val3\"] test message", "ul_id: R555, message: test message");
    expectLogMessage("ul_id: %U, message: %+", "[Tags: \"key1\":\"val1\",\"key2\":\"val2\",\"UlId\":\"H57748\"] test message", "ul_id: H57748, message: test message");

    expectLogMessage("%K", "[Tags: \"key1\":\"val1\",\"UlId\":\"R555\",\"ConnectionId\":\"7879\"] message1", "7879");
    expectLogMessage("%K", "[Tags: \"ConnectionId\":\"123\",\"key2\":\"val2\",\"key3\":\"val3\"] message1", "123");
    expectLogMessage("%K", "[Tags: \"key1\":\"val1\",\"ConnectionId\":\"asda\",\"UlId\":\"H57748\"] message1", "asda");

    expectLogMessage("%Q", "[Tags: \"StreamId\":\"as788\",\"UlId\":\"R555\",\"ConnectionId\":\"7879\"] message1", "as788");
    expectLogMessage("%Q", "[Tags: \"ConnectionId\":\"123\",\"StreamId\":\"ere8re7887\",\"key3\":\"val3\"] message1", "ere8re7887");
    expectLogMessage("%Q", "[Tags: \"key1\":\"val1\",\"ConnectionId\":\"asda\",\"StreamId\":\"tyty8778t7y\"] message1", "tyty8778t7y");

    expectLogMessage("%K %Q", "[Tags: \"key1\":\"val1\",\"ConnectionId\":\"asda\",\"StreamId\":\"tyty8778t7y\"] message1", "asda tyty8778t7y");
    expectLogMessage("%U %K %Q", "[Tags: \"StreamId\":\"as788\",\"UlId\":\"R555\",\"ConnectionId\":\"7879\"] message1", "R555 7879 as788");

    expectLogMessage("%+", "[Tags: \"StreamId\":\"as788\",\"UlId\":\"R555\",\"ConnectionId\":\"7879\"] message1", "message1");
}
