...
/**
 * FormatterProvider for event reporting.
 */
class EventFormatter : public StreamInfoFormatterProvider {
public:
  EventFormatter(const std::string& field, absl::optional<size_t> max_length);
