...
public:
  ...
  // Ericsson Envoy Proxy Flags - START
  constexpr static absl::string_view REQUEST_PAYLOAD_TOO_LARGE = "E_PTL"; 
  constexpr static absl::string_view INVALID_VIA_HEADER = "E_IVH";
  constexpr static absl::string_view MISSING_PATH_REJECTED = "E_MPR";
  constexpr static absl::string_view ABSOLUTE_PATH_REJECTED = "E_APR";

  constexpr static absl::string_view REQUEST_PAYLOAD_TOO_LARGE_LONG = "E_PaylodTooLarge"; 
  constexpr static absl::string_view INVALID_VIA_HEADER_LONG = "E_InvalidViaHeader";
  constexpr static absl::string_view MISSING_PATH_REJECTED_LONG = "E_MissingPathRejected";
  constexpr static absl::string_view ABSOLUTE_PATH_REJECTED_LONG = "E_AbsolutePathRejected";
  // Ericsson Envoy Proxy Flags - END
  ...
  static constexpr std::array ALL_RESPONSE_STRINGS_FLAGS{
      ...
      // Ericsson Envoy Proxy Flags - START
      FlagStringsAndEnum{{REQUEST_PAYLOAD_TOO_LARGE, REQUEST_PAYLOAD_TOO_LARGE}, ResponseFlag::PayloadTooLarge},
      FlagStringsAndEnum{{INVALID_VIA_HEADER, INVALID_VIA_HEADER_LONG}, ResponseFlag::InvalidViaHeader},
      FlagStringsAndEnum{{MISSING_PATH_REJECTED, MISSING_PATH_REJECTED_LONG}, ResponseFlag::MissingPathRejected},
      FlagStringsAndEnum{{ABSOLUTE_PATH_REJECTED, ABSOLUTE_PATH_REJECTED_LONG}, ResponseFlag::AbsolutePathRejected},
      // Ericsson Envoy Proxy Flags - END
  };
