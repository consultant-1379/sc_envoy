...
TagNameValues::TagNameValues() {
  ...
  // *_rq_(<response_code_class>)xx_per_roaming_partner
  addRe2(RESPONSE_CODE_CLASS, R"(_rq_((\d))xx_per_roaming_partner$)", "_rq_");

  // *_rq_(<response_code_class>)xx_per_nf
  addRe2(RESPONSE_CODE_CLASS, R"(_rq_((\d))xx_per_nf$)", "_rq_");
