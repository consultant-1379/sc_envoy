...
HostConstSharedPtr SubsetLoadBalancer::tryChooseHostFromContext(LoadBalancerContext* context,
                                                                bool& host_chosen) {
  // ENVOY_LOG(debug, "Enter tryChooseHostFromContext()");
  ...
  // ENVOY_LOG(debug, "Delegating host choice to RR LB");
