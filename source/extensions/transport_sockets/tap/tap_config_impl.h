...
private:
  ...
  const std::string local_ip_ = Common::Tap::EricUtility::getEnvOr("ERIC_SCP_WORKER_PORT_80_TCP_ADDR","");
  bool flag_ = false;
...
public:
  SocketTapConfigImpl(const envoy::config::tap::v3::TapConfig& proto_config,
                      ...
                      Server::Configuration::TransportSocketFactoryContext& context , Stats::Scope & scope)
