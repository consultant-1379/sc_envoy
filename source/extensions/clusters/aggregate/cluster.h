...
public:
  ...
  void analyzePrioritySet(Upstream::LoadBalancerContext* context) override;
...
private:
  ...
  public:
    LoadBalancerImpl(const PriorityContext& priority_context, Upstream::ClusterLbStats& lb_stats,
                     ...
                     AggregateClusterLoadBalancer* parent)
    ...
    // Upstream::LoadBalancer
    Upstream::HostConstSharedPtr chooseHost(Upstream::LoadBalancerContext* context) override;
    Upstream::HostConstSharedPtr chooseHostRec(Upstream::LoadBalancerContext* context, int num_rec=0);
  ...
  private:
    ...
    AggregateClusterLoadBalancer* parent_;
    std::string preferred_host_ = "";
  };
