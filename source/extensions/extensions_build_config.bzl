...
EXTENSIONS = {
    ...
    "envoy.retry_host_predicates.eric_omit_host_metadata_dynamic":   "//source/extensions/retry/host/eric_omit_host_metadata_dynamic:config",
    "envoy.retry_host_predicates.eric_loop_prevention":   "//source/extensions/retry/host/eric_loop_prevention:config",
    #
    # Retry priorities
    #

    "envoy.retry_priorities.previous_priorities":       "//source/extensions/retry/priority/previous_priorities:config",
    "envoy.retry_priorities.eric_reselect_priorities":       "//source/extensions/retry/priority/eric_reselect_priorities:config",
    ...
    #
    # Eric-Proxy SEPP/SCP filter
    #
    "envoy.filters.http.eric_proxy":                          "//source/extensions/filters/http/eric_proxy:config",
    
    "envoy.filters.http.eric_ingress_ratelimit":        "//source/extensions/filters/http/eric_ingress_ratelimit:config",
    #
    # IO socket
    #
    ...
    "envoy.tls.cert_validator.eric_sepp":               "//source/extensions/transport_sockets/tls/cert_validator/eric_sepp:eric_sepp",
