...
public:
  ...
  /**
   * returns if a retry should be spent on the preferred host. Valid for preferred
   * and strict routing scenarios
   */
  virtual bool shouldRetryPreferredHost() PURE;
  virtual void finalizePreferredHostRetries() PURE;
};
